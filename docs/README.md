...
| 5 | [Floors v1.5 — Finishing the Texture](design/FLOORS_V1_5.md) · [html](design/FLOORS_V1_5.html) | Polish pass closing six v1 gaps: tiered boss rewards, boss telegraph + arena dim, first-encounter counter tips, Codex Bestiary + Crucibles tabs, missing modifier wiring, post-boss reward room. | *not yet implemented* |
