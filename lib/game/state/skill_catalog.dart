...
class SkillDefinition {
  ...
  String descriptionForLevel(int level) {
    return switch (archetype) {
      ...
      SkillArchetype.reach => switch (level) {
        1 => 'Stat: targeting range increases.',
        2 => 'Special: sight-runes scan wider approach lanes.',
        3 => 'Stat: range increases again.',
        4 => 'Special: threats are acquired earlier in the skyline.',
        _ => 'Big upgrade: the nexus controls nearly the whole screen.',
      },
